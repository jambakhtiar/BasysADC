...
#set_property PACKAGE_PIN J3 [get_ports {}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {FROM_ADC(0)}]
#Sch name = XA2_P
set_property PACKAGE_PIN L3 [get_ports {XA2_P}]				
...
##Sch name = XA1_N
#set_property PACKAGE_PIN K3 [get_ports {FROM_ADC(1)}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {FROM_ADC(1)}]
##Sch name = XA2_N
set_property PACKAGE_PIN M3 [get_ports {XA2_N)}]				
